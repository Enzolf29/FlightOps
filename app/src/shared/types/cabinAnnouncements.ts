...
export const CABIN_ANNOUNCEMENT_DEFINITIONS: CabinAnnouncementDefinition[] = [
  ...
  { type: 'arm_doors', label: 'Arm Doors', trigger: 'Dès que le premier moteur commence à démarrer', icon: '🔒' },
  { type: 'presafety_briefing', label: 'Presafety Briefing', trigger: 'Après le démarrage du premier moteur et Arm Doors', icon: '🎙' },
